...
url = 'http://www.ratebeer.com/beer/stone--dogfish-head--victory-saison-du-buff/122227/101108/'
id = '101108'
# setAllReviewData(self, userID, url)
r_data = reviewData.ReviewData()
r_data.setAllReviewData(id, url)
print r_data.overallScore

# url = 'http://www.ratebeer.com/beer/backwoods-ridge-run-stout/187315/1786/'
# url = 'http://www.ratebeer.com/beer/evil-twin-modern-ipa/396491/1786/'
# r_data = reviewData.ReviewData()
# r_data.setAllReviewData(id, url)
# print r_data.beerCountryOfOrigin
